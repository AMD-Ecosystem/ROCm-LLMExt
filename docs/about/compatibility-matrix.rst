...
**************************************************************************************
AMD LLM Extension compatibility matrix
**************************************************************************************
...
.. table::
   ...
   |                              | verl/en/docs-26.09/install/                        | MI355X           |              |        |                      |                | tree/release/0.9.0.amd0/docker/rocm>`__    |
   |                              | verl-install.html>`__                              |                  |              |        |                      |                |                                            |
   +                              +----------------------------------------------------+------------------+--------------+--------+----------------------+----------------+--------------------------------------------+
   ...
   +                              +----------------------------------------------------+------------------+--------------+--------+----------------------+----------------+--------------------------------------------+
   |                              | `Ray 2.55.1                                        | MI300X,          | 7.2.1        | 22.04  | 2.10.0               | 3.12           | |docker-icon| `rocm/ray                    |
   |                              | <https://rocm.docs.amd.com/projects/               | MI325X,          |              |        |                      |                | <https://hub.docker.com/r/rocm/            |
   |                              | ray/en/docs-26.06/install/                         | MI355X           |              |        |                      |                | ray/tags?name=ray-2.55>`__                 |
   |                              | ray-install.html>`__                               |                  |              |        |                      |                |                                            |
   +------------------------------+----------------------------------------------------+------------------+--------------+--------+----------------------+----------------+--------------------------------------------+
   | :version-start:`26.04`       | `ComfyUI 0.18.2                                    | MI355X,          | 7.2.0,       | 24.04, | 2.10.0a0+git449b176  | 3.12           | |docker-icon| `rocm/comfyui                |
   ...
   +------------------------------+----------------------------------------------------+------------------+--------------+--------+----------------------+----------------+--------------------------------------------+
   | :version-start:`26.03`       | `FlashInfer 0.5.3                                  | MI355X,          | 7.2.0,       | 24.04  | 2.9.1                | 3.12           | |docker-icon| `rocm/flashinfer             |
   ...
   +                              +----------------------------------------------------+------------------+--------------+--------+----------------------+----------------+--------------------------------------------+
   |                              | `Triton Inference Server 25.12                     | MI355X,          | 7.2.0        | 24.04  | N/A                  | 3.12           | |docker-icon| `rocm/tritoninferenceserver  |
   ...
   +------------------------------+----------------------------------------------------+------------------+--------------+--------+----------------------+----------------+--------------------------------------------+
   | :version-start:`26.02`       | `FlashInfer 0.2.5                                  | MI325X,          | 7.1.1        | 24.04  | 2.8.0                | 3.12           | |docker-icon| `rocm/flashinfer             |
   |                              | <https://rocm.docs.amd.com/projects/               | MI300X           |              |        |                      |                | <https://hub.docker.com/r/rocm/            |
   |                              | flashinfer/en/docs-26.02/install/                  |                  |              |        |                      |                | flashinfer/tags?name=                      |
   |                              | flashinfer-install.html>`__                        |                  |              |        |                      |                | flashinfer-0.2.5.amd2>`__                  |
   +                              +----------------------------------------------------+------------------+--------------+--------+----------------------+----------------+--------------------------------------------+
   |                              | `Ray 2.51.1                                        | MI300X           | 7.0.0        | 22.04  | 2.9.0a0+git1c57644   | 3.12           | |docker-icon| `rocm/ray                    |
   |                              | <https://rocm.docs.amd.com/projects/               |                  |              |        |                      |                | <https://hub.docker.com/r/rocm/            |
   |                              | ray/en/docs-26.02/install/                         |                  |              |        |                      |                | ray/tags?name=ray-2.51>`__                 |
   |                              | ray-install.html>`__                               |                  |              |        |                      |                |                                            |
   +                              +----------------------------------------------------+------------------+--------------+--------+----------------------+----------------+--------------------------------------------+
   |                              | `verl 0.6.0                                        | MI300X           | 7.0.0        | 22.04  | 2.9.0                | 3.12           | |docker-icon| `rocm/verl                   |
   |                              | <https://rocm.docs.amd.com/projects/               |                  |              |        |                      |                | <https://hub.docker.com/r/rocm/            |
   ...
   +------------------------------+----------------------------------------------------+------------------+--------------+--------+----------------------+----------------+--------------------------------------------+
   | :version-start:`25.09`       | `FlashInfer 0.2.5                                  | MI300X           | 6.4.1        | 24.04  | 2.7.1                | 3.12           | |docker-icon| `rocm/flashinfer             |
   |                              | <https://rocm.docs.amd.com/projects/               |                  |              |        |                      |                | <https://hub.docker.com/r/rocm/            |
   ...
   +------------------------------+----------------------------------------------------+------------------+--------------+--------+----------------------+----------------+--------------------------------------------+
   | :version-start:`25.08`       | `Ray 2.48.0.post0                                  | MI300X,          | 6.4.1        | 24.04  | 2.6.0+git684f6f2     | 3.12           | |docker-icon| `rocm/ray                    |
   ...
   +                              +----------------------------------------------------+------------------+--------------+--------+----------------------+----------------+--------------------------------------------+
   |                              | `verl 0.3.0.post0                                  | MI300X           | 6.2.0        | 20.04  | 2.5.0                | 3.9            | |docker-icon| `rocm/verl                   |
   |                              | <https://rocm.docs.amd.com/projects/               |                  |              |        |                      |                | <https://hub.docker.com/r/rocm/            |
